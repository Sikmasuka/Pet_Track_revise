...
<body class="bg-gray-100 flex">
    ...
    <div id="sidebar" class="fixed inset-y-0 left-0 w-50 bg-gradient-to-b from-green-500 to-green-600 text-white p-5 transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out z-40">
        ...
        <nav class="mt-8 lg:mt-20">
            ...
            <a href="pets.php" class="block text-md lg:text-md text-white bg-green-600 px-4 py-2 mb-1 rounded-md">
    ...
    <div class="ml-0 lg:ml-52 p-4 pt-16 lg:pt-4 w-full">
        <header class="bg-white rounded-lg text-green-800 py-4 shadow-sm mb-6 lg:mb-8 p-4 lg:p-6">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <h1 class="text-lg sm:text-xl lg:text-2xl font-bold">Manage Pets</h1>
            </div>
        </header>
                    ...
                    <table class="min-w-full divide-y divide-gray-800">
                        <thead class="bg-gray-50 sticky top-0 z-2">
                            <tr class="border-b bg-gray-200">
                                ...
                                <th class="px-2 py-3 text-left text-xs sm:text-sm font-medium text-gray-500 uppercase tracking-wider min-w-[120px] whitespace-nowrap overflow-hidden truncate">Species</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <?php foreach ($pets as $pet): ?>
                                <tr class="border-b hover:bg-gray-100">
                                    ...
                                    <td class="px-4 py-2"><?= htmlspecialchars($pet['pet_species']) ?></td>
